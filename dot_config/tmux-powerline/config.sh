...
# General {
    ...
    export TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR="#191724"
    export TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR="#9ccfd8"

	# The theme to use.
	export TMUX_POWERLINE_THEME="joskaf"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/joskaf/.mail/inbox/new"

	## mbox
	# Path to the mbox to check.
	export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/spool/mail/joskaf"

	## mailcheck
	# Optional path to mailcheckrc
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/joskaf/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/joskaf/.now_playing.log"
